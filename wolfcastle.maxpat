...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 759.0, 655.5, 47.0, 36.0 ],
					"style" : "",
					"text" : "attack time",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 811.22229, 655.5, 48.0, 36.0 ],
					"style" : "",
					"text" : "decay time",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 863.93335, 655.5, 53.0, 36.0 ],
					"style" : "",
					"text" : "sustain gain ",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 920.666748, 655.5, 55.0, 36.0 ],
					"style" : "",
					"text" : "release time",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 866.93335, 691.0, 30.535635, 30.535635 ],
					"size" : 100.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 920.666748, 691.0, 30.535635, 30.535635 ],
					"size" : 100.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 813.22229, 691.0, 30.535635, 30.535635 ],
					"size" : 100.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 760.25, 691.0, 30.535635, 30.535635 ],
					"size" : 100.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 734.0, 731.5, 20.0, 20.0 ],
...
,
					"patching_rect" : [ 734.0, 773.0, 124.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 900.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-36::obj-41" : [ "live.dial[7]", "Min", 0 ],
			...
			"obj-36::obj-43" : [ "live.dial[6]", "Max", 0 ],
			...
			"obj-2::obj-61" : [ "live.text[38]", "live.text[1]", 2 ],
			...
			"obj-2::obj-66" : [ "live.text[27]", "live.text", 0 ],
			...
			"obj-6::obj-60" : [ "live.text[7]", "live.text[1]", 2 ],
			"obj-36::obj-78" : [ "live.text[14]", "live.text[4]", 0 ],
			"obj-1::obj-33" : [ "live.text[11]", "live.text", 0 ],
			"obj-1::obj-32" : [ "live.text[28]", "live.text", 0 ],
			"obj-6::obj-88" : [ "live.text[19]", "live.text[4]", 0 ],
			"obj-2::obj-88" : [ "live.text[25]", "live.text[4]", 0 ],
			"obj-2::obj-60" : [ "live.text[39]", "live.text[1]", 2 ],
			...
			"obj-2::obj-78" : [ "live.text[26]", "live.text[4]", 0 ],
			"obj-2::obj-43" : [ "live.dial[44]", "Max", 0 ],
			"obj-8::obj-43" : [ "live.dial[3]", "Max", 0 ],
			"obj-2::obj-7" : [ "live.toggle[6]", "live.toggle", 0 ],
			"obj-1::obj-4" : [ "live.dial[15]", "Size", 0 ],
			"obj-6::obj-38" : [ "live.dial[20]", "Size", 0 ],
			"obj-1::obj-31" : [ "live.text[3]", "live.text", 0 ],
			"obj-6::obj-78" : [ "live.text[9]", "live.text[4]", 0 ],
			"obj-1::obj-19" : [ "live.text[29]", "live.text", 0 ],
			"obj-19" : [ "live.dial[39]", "Pan", 0 ],
			"obj-36::obj-66" : [ "live.text[15]", "live.text", 0 ],
			"obj-8::obj-7" : [ "live.toggle", "live.toggle", 0 ],
